...
@Suppress("unused")
object RdUnoPluginModel : Ext(SolutionModel.Solution) {
    ...
    init {
        setting(Kotlin11Generator.Namespace, "com.jetbrains.rider.plugins.unoplugin.model")
        setting(CSharp50Generator.Namespace, "Rider.Plugins.UnoPlugin.Model")
